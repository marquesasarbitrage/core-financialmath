...
class BaroneAdesiWhaley {
    ...
    public: 
        ...
        static double getOptimalExercisePrice(double futurePrice, double drift, double strike, double timeToMaturity, double sigma, double interestRate, bool isCall);
    ...
    private: 
        ...
        static double _getOptimalExercisePrice(double drift, double strike, double timeToMaturity, double sigma, double interestRate, bool isCall);
